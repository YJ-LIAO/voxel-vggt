...
def main(args):
    if args.eval_dataset == "sintel":
        ...
        img_pathes_folder = [
            f"../data/long_data/long_bonn_s1/rgbd_bonn_dataset/rgbd_bonn_{seq}/rgb_{bonn_number}/*.png"
            for seq in seq_list
        ]
        img_pathes = []
        ...
        depth_pathes_folder = [
            f"../data/long_data/long_bonn_s1/rgbd_bonn_dataset/rgbd_bonn_{seq}/depth_{bonn_number}/*.png"
            for seq in seq_list
        ]
        depth_pathes = []
        for depth_pathes_folder_i in depth_pathes_folder:
